...
*Overall the shifts between the modern landscape and the pre-European settlement is marked by large scale forest stabilization, a shift from bimodal distribution in tree cover characterized by closed forests and open savannas, to mostly closed forested ecosystems. 

Take home point:
Temperate Midwest was previously altenative savanna and forest stable states, but ~ 150 years of land use changes, changes in climate have altered the stability, and pushed the region towards more stable forests. 

Experimental evidence from other temperate prairies and shrublands suggest that fire suppression may push ecosystms past the threshold, making the activation effort needed to return to open landscapes much higher. 

Limitations of the analysis:
* distribution in tree density is still poorly constrained
* evidence for alternative stable states is circumstantial, but strong 
* limitations and sparcity of modern FIA data
  -may be sampling forests that are likely regenerating post-logging and still have low tree density
* Modern landscape has also undergone land conversion from forest/open to agricultural landscapes, however, places that were lower tree denisty in the past are now 
* projections of future climate don't include changes in land use
