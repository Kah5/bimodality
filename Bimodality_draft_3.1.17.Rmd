...
pls.density.hists<- ggplot(full[full$PC1_bins_f2 %in% c('-1 - 0', "0 - 1", "1 - 2"), ], aes(PLSdensity, fill = period)) + geom_density(alpha = 0.5, position = 'identity')+xlim(0,700)+
  facet_wrap(~PC1_bins_f2, ncol = 4 , scales = "free_x")+theme_bw()+scale_fill_manual(values = c("red", "blue"), limits = c("Modern", "Past"))+coord_flip()+theme(axis.title.x=element_blank(),
