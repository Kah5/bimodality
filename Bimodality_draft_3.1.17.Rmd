...
fig1B <- ggplot(df.new, aes(x = MAP1910, y = pasttmean))+ geom_point()+ 
...
fig1C <- map.bimodal.5c( data = dens.pr, binby = 'PC1bins', density = "PLSdensity" )+theme(axis.text = element_blank(),legend.justification = c(-0.1, 0), legend.position = c(0, 0))

fia.dens <- read.csv("outputs/FIA_pls_density_with_bins.csv")

fig1F <- map.bimodal.5c( data = fia.dens, binby = 'PC1fiabins', density = "FIAdensity" )+theme(axis.text = element_blank(),legend.justification = c(-0.1, 0), legend.position = c(0, 0))
fig1F
