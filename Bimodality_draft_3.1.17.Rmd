...
In the past, tree density could only be partially explained by climate. Tree density was low at very low mean annual precipitaiton (600mm/year), however at intermediate precipitation between 700 - 1000 mm/year, both high and low tree densities are possible and form a significant bimodal distribution (PRSIM Mean annual precipitaiton 1885-1925). This suggests that for temperate savannas, very low moisture may serve as a low boundary condition for tree growth, but may not be the most important factor deterimining tree denisty. Moderate mean annual temperatures (5-11 degC) overlapped with the intermediate precipitation space where savannas and forests were possible. To determine if the distribution of tree density was bimodal and not well explained by climate or edaphic factors, we evaluated distributions of tree density over equal intervals of the 1st principal component of environmental variables, which explains 54% of variance. Past precipitation and Past Temperature both have strong positive loadings on PC1, while temperature seasonality (CV) and precipitation seasonality index (SI) both have negative loadings fro PC1.  This identified significant bimodal distributions between xx - xx scores of PC1, which corresponded to intermediate values of temperature and precipitation (XXXX mm/year and XX - XX degC). Based on this analysis, 34% (212,032 km^2) of the the past landscape was bimodal (figure 4) during the PLS time. 
...
-Past vegetation was likely bistable and not determined soley by climate and soil factors in the region. The high frequency of savanna and closed forest density modes, with scarce observations of intermediate density in the past suggests that ~50 trees/ hectare was an unstable point in the past. Importantly, 
-Large scale shifts in tree density distributions in the region have altered the stability of the North American midwest, and have promoted closed forests
