...
png("outputs/oak_PC1_hexbin.png")
pls.oak.hex
dev.off()
...
png("outputs/maple_PC1_hexbin.png")
pls.maple.hex
dev.off()
...
png("outputs/hemlock_PC1_hexbin.png")
pls.hemlock.hex
dev.off()
...
png("outputs/beech_PC1_hexbin.png")
pls.beech.hex
dev.off()
...
full.comps$newPCbins_f <- factor(full.comps$newPCbins, levels=c("Mesic/Other", "Bimodal (-1 - 1)", "Oak"))
...
D <- arrangeGrob(gcomp+theme_bw(), top = textGrob("D", x = unit(0.1, "npc")
        , y = unit(1, "npc"), just=c("left","top"),
        gp=gpar(col="black",    fontsize=18, fontfamily="Times Roman")))
...
# take all these figures and mash into one big mega figure
png(height = 10, width = 10, units = "in", res = 300, "outputs/paper_figs/fig3.png")
