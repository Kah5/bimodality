...
1. Intro:
  ...
  * Alt. stable states have been well documented in the modern day tropics, but studies documenting alternative stable states in temperate regions of the world are scarce. However, if fire/disturbance driven alternative stable states once existed in parts of the temperate zone, large scale fire suppression in N. America (CITE Anderson mesophication paper) and Europe (CITE??) would have removed the vegetation-disturbance feedbacks from the landscape. 
