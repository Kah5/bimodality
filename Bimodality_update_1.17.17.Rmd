...
ggplot(merged, aes(x = podiff, fill = classification)) + geom_vline(data = dfs, aes(xintercept=0), colour="red") +geom_histogram()+facet_grid(classification~., scales = 'free') + xlab("Predicted - Observed for different Bimodal regions")
