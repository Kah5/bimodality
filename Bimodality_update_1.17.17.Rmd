...
Savanna and forest alternative states have been well documented in the tropics(@staver_2011, @hoffmann_2012, @dantas_2016a), but have not been well documented elsewhere on the landscape. While the Upper Midwest in North American is largely forested or agricultural land use today, historical vegetation surveys documented open savanna regions in the region before the time of European settlement (@grimm_1984, @danz_2011, @goring_2016). Several alternative hypotheses for the existance of open savanna ecosystems in the mesic/temperate midwest have been proposed: 
