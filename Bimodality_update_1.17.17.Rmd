...
We can also make maps of the 1st Principal Component Climate space where BC > 5.5 for PLS:

![](outputs/v1.6-5/PLS_FIA_PC1_BC_map.png)

Maps of the 2nd Principal Component Climate space where BC > 5.5 for PLS:
