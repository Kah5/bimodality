...
PLS.lgr4 <- gam(ecocode ~ s(pastdeltaT), family = 'binomial',data = train)
PLS.lgr4L <- gam(ecocode ~ pastdeltaT, family = 'binomial',data = train)
...
#PLS.lgr13 <- gam(ecocode ~ s(MAP1910)  + s(pasttmean) + s(pastdeltaT), family = 'binomial',data = train)
#PLS.lgr13L <- gam(ecocode ~ MAP1910  + pasttmean + pastdeltaT, family = 'binomial',data = train)

PLS.lgr14 <- gam(ecocode ~ s(MAP1910)  + s(pasttmean) + s(pastdeltaT) + s(pastdeltaP), family = 'binomial',data = train)
PLS.lgr14L <- gam(ecocode ~ MAP1910  + pasttmean + pastdeltaT + pastdeltaP, family = 'binomial',data = train)
...
forest type ~ s(MAP1910)+ s(pasttmean) + s(pastdeltaT) +   s(pastdeltaP)
