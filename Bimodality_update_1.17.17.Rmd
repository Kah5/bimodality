...
### Alternative Intro 
   ...
   Understanding forest response to environmental changes is a key challenge to predicting and planning for the future. Forest response may be deteriministic in some places, but non-linear and non-deterministic vegetation-climate relationships can result in divergent forest responses. In the tropics, alternative savanna and forest stable states coexist within the same climate due to vegetation-disturbance feedbacks(staver et al. ). These vegetation-disturbance feedbacks predict that increased disturbances (fire, logging, ungulates) would result in a a collapse of closed forests to the low tree density savanna state and suggests large scale forest instability across the tropics (staver et al. ..). 
