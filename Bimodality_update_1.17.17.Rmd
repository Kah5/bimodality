...
A. % Sand, Available Water Content (awc), and saturated hydraulic conductivity (ksat) do not explain tree density well. Additionally, doing a PCA on the environmental dataset and using PC1 and PC2 as explanatory variables do not explain tree density.
...
To answer this, we have to define a bimodality index. There are a few options for this:
