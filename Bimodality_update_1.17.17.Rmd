...
1a. "Alternative Intro*" *Contains no alternative facts
  * Savanna and forest vegetation have been proposed to be currently alternative stable states in some regions of the globe (mostly in the tropics). 
  * At a large scale, moisture gradients certainly have somecontrol the distribution (deterministic hig and low precip creates forests and savs. respectively)
  * However, at intermediate precipitation climates, savanna/forest alternative stable states are controlled by fire/disturbance vegetation feedbacks. 
...
1b. "Alternative Introb*" *Also no alternative facts
...
![](ouputs/v1.6-5/full/RCP_scenario_PC1_maps_FIA.png)
...
PLS.gam14 <- gam(PLSdensity ~ s(MAP1910)  + s(pasttmean) + s(pastdeltaT) + s(pastdeltaP), data = train, family = quasipoisson(link = "log"))
