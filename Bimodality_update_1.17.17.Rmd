...
Bimodality coefficient is calculated from the distribuiton of data as follows:

BC = $\frac{(skew^2 + 1)}{(kurtosis + 3)*\frac{(n-1)^2}{(n-2)*(n-3)}}$

We calculated the BC for the datasets overall, and the BC within different bins of precipitation and bins of the 1st Principal Componenets. 

*Pricipal Component Analysis*
Since many climate and soils variables are often correlated, a pricipal components analysis was conducted to reduce dimensions and co-linearity in the environmental data. The 1st Principal component was then used as a covariate in the dataset

*Generalized Additive Models*
Several generalized additive models (GAMs) were developed to determine if tree density can be deterministically predicted by climate and/or soils. 
...
![](outputs/v1.6-5/PLS_full_tree_density_map.png)
