...
png("outputs/paper_figs_unc/density_by_7_spec_clusters.png")
...
png("outputs/paper_figs_unc/PLS_hist_bins_by_envt_species_cluster.png")
...
png(height = 5, width = 5, units = "in", res = 300, "outputs/paper_figs_unc/hist_by_community_JJA_soil.png")
clust.hist.jja_soil
dev.off()
...
png(height = 10, width = 6, units = "in", res = 500, "outputs/paper_figs_unc/new_figure_3_kde_plot_with_hist.png")
