...
png("outputs/mixture_model/basic_mixture_model_histogram.png")
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/PC1_mixture_mode_densityplot_by_pc1.png")
...
msk2 <- caTools::sample.split( fia, SplitRatio = 3/4, group = NULL )
...
png("outputs/mixture_model/basic_mixture_model_histogram_fia_pc1.png")
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/PC1_mixture_mode_densityplot_by_pc1_FIA.png")
density.plots.fia.pc1
dev.off()

fia.nona %>% group_by(pc1_bins_fia, mode) %>% summarise(mean = mean(mean_dens_fia), 
...
png(height = 6, width = 6, units = "in", res = 300, "outputs/mixture_model/hysteresis_pc1_fia.png")
hysteresis.pc1.fia
dev.off()
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/GS_ppet_mixture_mode_densityplot_by_GS_ppet.png")
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/GS_ppet_mod_mixture_mode_densityplot_by_GS_ppet_mod.png")
...
png(height = 6, width = 6, units = "in", res = 300, "outputs/mixture_model/hysteresis_ppet_fia.png")
hysteresis.ppet.fia
dev.off()
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/mean_GS_soil_mixture_mode_densityplot_by_mean_GS_soil.png")
...
png(height = 6, width = 12, units = "in", res = 300, "outputs/mixture_model/mean_GS_soil_m_mixture_mode_densityplot_by_mean_GS_soil_m.png")
...
png(height = 6, width = 6, units = "in", res = 300, "outputs/mixture_model/hysteresis_soil_fia.png")
hysteresis.soil.fia
dev.off()
