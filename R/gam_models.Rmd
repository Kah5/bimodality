...
PLS.gam4 <- gam(PLSdensity ~ s(pasttmean) + s(pastdeltaP) ,  data = train)
PLS.gam4L <- gam(PLSdensity ~ pasttmean + pastdeltaP ,  data = train)
...
AIC(PLS.gam1, PLS.gam2, PLS.gam3, PLS.gam4, PLS.gam5, PLS.gam6, PLS.gam7, PLS.gam8, PLS.gam9, PLS.gam1L, PLS.gam2L, PLS.gam3L, PLS.gam4L, PLS.gam5L, PLS.gam6L, PLS.gam7L, PLS.gam8L, PLS.gam9L)
...
# logmod 
logmod<- gam(ecocode ~ s(MAP1910) + s(pasttmean) + s(sandpct), family = binomial, data = train)

logmodL <- gam(ecocode ~ MAP1910 + pasttmean + sandpct, family = binomial, data = train)
summary(logmod)
plot(logmod)
