                                                     ...
                                                     ifelse(dens$mean_dens > 200 & dens$mean_dens <= 300, "200-300", 
                                                            ifelse(dens$mean_dens > 300 & dens$mean_dens <= 400, "300-400",
                                                                   ifelse(dens$mean_dens > 400 & dens$mean_dens <= 500, "400-500",
                                                                          ifelse(dens$mean_dens > 500 , "500+", "No FIA plots"))))))))

dens$density_discrete <- factor(dens$density_discrete, c("Prairie", "Savanna","47-100", "100-200", "200-300", "300-400", "400-500",  "500+", "No FIA plots"))
...
pls.map.alt.color <- ggplot()+ geom_polygon(data = mapdata, aes(group = group,x=long, y =lat), fill = 'darkgrey')+
  ...
  scale_fill_manual(values = c('#dfc27d',
                               ...
                               '#41ab5d',
                               '#238443',
                               '#005a32',"darkgrey"), name ="Tree Density", na.value = 'darkgrey', drop = TRUE) +
...
pls.map.alt.color.msk <- ggplot()+ geom_polygon(data = mapdata, aes(group = group,x=long, y =lat), fill = 'darkgrey')+
  ...
  scale_fill_manual(values = c('#dfc27d',
                               ...
                               '#41ab5d',
                               '#238443',
                               '#005a32',"darkgrey"), name ="Tree Density", na.value = 'darkgrey', drop = FALSE) +
                                                            ...
                                                            ifelse(dens$media_dens > 200 & dens$media_dens <= 300, "200-300", 
                                                                   ifelse(dens$media_dens > 300 & dens$media_dens <= 400, "300-400",
                                                                          ifelse(dens$media_dens > 400 & dens$media_dens <= 500, "400-500",
                                                                                 ifelse(dens$media_dens > 500 , "500+", "No FIA plots"))))))))
...
#myColors <- c( '#386cb0','#ffff99','#bf5b18','#beaed4','#a6cee3','#6a3d9a','#f0028f','#8fc98f') # new color scheme
...
clust.hist.full.no.aspect <- ggplot()+ geom_density(data = dens.clust[dens.clust$mean_dens >= 0.5,], aes(mean_dens, 22 *..count..),linetype="dashed" , color = "darkgrey", bw = 12,size = 1.5)+ 
  geom_histogram(data = dens.clust[dens.clust$mean_dens >= 0.5,], aes(mean_dens, fill = orderedforesttype), binwidth =  20)+xlim(0,600)+
  scale_fill_manual(values = myColors, name = " ")+coord_flip()+ylim(0,1050)+xlab("PLS tree density")+ylab("# grid cells")+theme_bw(base_size = 8)+theme(legend.position = c(0.5, 0.83),legend.background = element_rect(fill=alpha('transparent', 0)), legend.key.size = unit(0.2, "line"),legend.key = element_rect(color = "black", linetype ="solid"), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
clust.hist.full.msk <- ggplot()+ geom_density(data = dens.clust[dens.clust$mean_dens >= 0.5 & !is.na(dens.clust$FIAdensity),], aes(mean_dens, 22 *..count..),linetype="dashed" , color = "darkgrey", bw = 12,size = 1.5)+ 
  ...
  scale_fill_manual(values = myColors, name = " ")+coord_flip()+ylim(0,1050)+xlab("PLS tree density")+ylab("# grid cells")+theme_bw(base_size = 8)+theme(legend.position = c(0.44, 0.85),legend.background = element_rect(fill=alpha('transparent', 0)), legend.key.size = unit(0.4, "line"),legend.key = element_rect(color = "black", linetype ="solid"), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
clust.hist.full.msk
...
clust.hist.full.both <- ggplot()+ geom_density(data = dens.clust[dens.clust$mean_dens >= 0.5,], aes(mean_dens, 22 *..count..),linetype="dashed" , color = "darkgrey", bw = 12,size = 1.5)+ 
  ...
  scale_fill_manual(values = compColors, name = " ", drop = FALSE)+coord_flip()+xlab("PLS tree density")+ylab("# grid cells")+theme_bw(base_size = 10)+theme(aspect.ratio = 1,legend.position = c(0.44, 0.105),legend.background = element_rect(fill=alpha('transparent', 0)), legend.key.size = unit(0.4, "line"),legend.key = element_rect(color = "black", linetype ="solid"), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
                                                     ...
                                                     ifelse(dens$mean_dens_fia > 200 & dens$mean_dens_fia <= 300, "200-300", 
                                                            ifelse(dens$mean_dens_fia > 300 & dens$mean_dens_fia <= 400, "300-400",
                                                                   ifelse(dens$mean_dens_fia > 400 & dens$mean_dens_fia <= 500, "400-500",
                                                                          ifelse(dens$mean_dens_fia > 500 , "500+", "NA"))))))))

dens$density_discrete<- factor(dens$density_discrete, c("Prairie", "Savanna","47-100", "100-200", "200-300", "300-400", "400-500",  "500+"))
                                                         ...
                                                         ifelse(dens$ci.low_dens_fia > 200 & dens$ci.low_dens_fia <= 300, "200-300", 
                                                                ifelse(dens$ci.low_dens_fia > 300 & dens$ci.low_dens_fia <= 400, "300-400",
                                                                       ifelse(dens$ci.low_dens_fia > 400 & dens$ci.low_dens_fia <= 500, "400-500",
                                                                              ifelse(dens$ci.low_dens_fia > 500 , "500+", "No FIA plots"))))))))
                                       ...
                                       ifelse(dens$mean_dens_fia > 47 & dens$mean_dens_fia <= 100, "47-100",
                                              ifelse(dens$mean_dens_fia > 100 & dens$mean_dens_fia <= 200, "100-200", 
                                                     ifelse(dens$mean_dens_fia > 200 & dens$mean_dens_fia <= 300, "200-300", 
                                                            ifelse(dens$mean_dens_fia > 300 & dens$mean_dens_fia <= 400, "300-400",
                                                                   ifelse(dens$mean_dens_fia > 400 & dens$mean_dens_fia <= 500, "400-500",
                                                                          ifelse(dens$mean_dens_fia > 500 , "500+", "No FIA plots"))))))))
...
fiaColors <- c('#003c30','#a6cee3',"#beaed4","#e31a1c", '#b3de69')
names(fiaColors) <- levels(clust_5test$orderedforesttype)
...
fia.pet.dens.comp <- ggplot(clust_5test, aes(GS_ppet_mod,mean_dens_fia,  color = orderedforesttype))+geom_point(size = 0.25)+ylim(0, 500)+
  theme_bw()+ylab("Modern Tree Density (trees/ha)")+xlab("Growing Season P-PET")+scale_color_manual(values = fiaColors, name = "FIA composition", drop = TRUE)+theme(legend.key.size = unit(1.5, "point"))+guides(color = guide_legend(override.aes = list(size = 5)))
fia.pet.dens.comp

pls.pet.dens.comp <- ggplot(clust_8, aes(GS_ppet,mean_dens,  color = orderedforesttype))+geom_point(size = 0.25)+ylim(0, 500)+
  theme_bw()+ylab("Modern Tree Density (trees/ha)")+xlab("Growing Season P-PET")+scale_color_manual(values = myColors, name = "PLS composition")+theme(legend.key.size = unit(1.5, "point"))+guides(color = guide_legend(override.aes = list(size = 5)))
...
clust_10_fia$orderedforesttype <- factor(clust_10_fia$foresttype, c("Oak", "Pine", "Aspen", "N. Mixed Forest", "Boreal/Sub-boreal","Oak/Maple/Ash", "Oak-Hickory", "Beech-Maple", "Maple Mixed Forest", "Oak-Mixed"))
...
clust.hist.fia.full.both.no.aspect.msk <- ggplot()+ geom_density(data = clust_10_fia_msk[clust_10_fia_msk$mean_dens_fia >= 0.5,], aes(mean_dens, 22 *..count..), linetype="dashed" , color = "darkgrey", bw = 12,size = 1.5)+ 
  ...
  geom_histogram(data = clust_10_fia_msk[clust_10_fia_msk$mean_dens_fia >= 0.5,], aes(mean_dens_fia, fill = orderedforesttype), binwidth =  20)+xlim(0,600)+
  scale_fill_manual(values = compColors, name = " ", drop = TRUE)+
  coord_flip()+xlab("FIA tree density")+ylab("# grid cells")+theme_bw(base_size = 6)+theme(legend.position = c(0.44, 0.85),legend.background = element_rect(fill=alpha('transparent', 0)), legend.key.size = unit(0.1, "line"),legend.key = element_rect(color = "black", linetype ="solid"), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
both.comp$orderedforesttype <- factor(both.comp$foresttype, c("Oak", "Pine", "Aspen", "N. Mixed Forest", "Boreal/Sub-boreal","Oak/Maple/Ash", "Oak-Hickory", "Beech-Maple", "Maple Mixed Forest", "Oak-Mixed"))
#clust_10$orderedforesttype <- factor(dens.clust$foresttype, levels = rev(c("Aspen", "Maple Mixed Forest", "Oak-Mixed","Oak/Maple/Ash","Oak-Hickory","Pine","Oak",  "Boreal/Sub-boreal", "N. Mixed Forest",  "Beech-Maple")))

# create a stable coloring scheme:
compColors <- c('#386cb0',"#f0027f",'#ff7f00',"#ffff99","#7fc97f", "#beaed4",'#a6cee3',"#b15928",  "#004529",  '#fdc086')
names(compColors) <- levels(both.comp$orderedforesttype)
...
bimodal.region.shifts.full <- ggplot(pc.clust2, aes(fia_pc1, fia_pc2))+geom_point(size = 0.2, color = "darkgrey")+geom_point(data = pc.clust2, aes(pls_pc1, pls_pc2, color = foresttype), size = 0.2)+scale_color_manual(values = compColors, name = " ", drop = TRUE)+
  ...
  xlab("Species Composition PC1 \n(43.5% variance explained)")+theme(legend.position = "right",legend.direction = "vertical", legend.title = element_blank(), legend.key.size = unit(1,'lines'), panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
...
past.survey <- read.csv("data/FIA_plot_data/fia.by.cell.dbh.out_1980_1990_TPA_1in.csv")
...
modern.fia <- read.csv("FIA_species_plot_parameters_paleongrid_1incutoff.csv")
density_taxon_cell.dia_all<- read.csv( "outputs/FIA_density_taxon_cell.dia_all.csv")


#density_taxon_cell.dia_all [unique(cell, x,y, total, DIA_classes)]
modern.fia <- density_taxon_cell.dia_all [,c("x", "y", "cell", "DIA_classes", "totaldia")]
modern.fia$INVYRcd <- "2000s"
colnames(modern.fia) <- c("x", "y", "cell","DIA_class",  "FIAdensity", "INVYRcd")
modern.fia$INVYR <- 2000


full.fia.surveys <- rbind(modern.fia, past.survey[,c("x", "y", "cell", "DIA_class","FIAdensity","INVYRcd", "INVYR")])
...
mean.fia.surveys <- full.fia.surveys %>% group_by(x,y,cell, INVYRcd, DIA_class) %>% dplyr::summarise(Density = mean(FIAdensity, na.rm = TRUE))

fia.surveys.wide <- mean.fia.surveys %>% group_by(x,y, cell, DIA_class) %>% spread(key = INVYRcd, value = Density)
...
ncell.change.1980.1990 <- fia.surveys.wide %>% group_by(dens.bins.1980, DIA_class) %>% dplyr::summarise(n_inc = sum(pct_inc_1980_1990 > 5, na.rm = TRUE),
...
bins.df <- data.frame(dens.bins.1980 = unique(ncell.change.1980.1990$dens.bins.1980),
           start.bin = c(0, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650),
           end.bin = c( 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700))

ncell.change.1980.1990 <- merge(ncell.change.1980.1990, bins.df)
...
ncell.pct.change.1980.1990.plot <- ggplot(ncell.pct.change.1980.1990, aes(xval.inc, start.bin))+geom_segment(aes(xend = xval.inc, yend = end.bin-20, size = pct_inc/2),
  ...
  geom_point(data = ncell.pct.change.1980.1990, aes(xval.nochange, start.bin+20, size = pct_nochange), color = "#636363")+
  geom_segment(aes(x = xval.dec, y = end.bin-20, xend = xval.dec, yend = start.bin, size = pct_dec), arrow = arrow(length = unit(0.1,"cm")), color = "#b2182b")+
  scale_size(range = c(0, 2))+scale_x_discrete(labels=c("2" = "No Change", "1" = "Increasing",
                                                        "3" = "Decreasing"))+theme_bw()+ylim(0,600)+
  facet_wrap(~DIA_class)+theme(axis.text.x = element_text(angle = 90, hjust = 1),axis.title.x  = element_blank(), legend.position = "none", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +ylab("Tree Density") +ggtitle("% of grid cells changing density \n between 1980's and 1990's")
...
ncell.change.1980.1990.plot <- ggplot(ncell.change.1980.1990, aes(xval.inc, start.bin))+geom_segment(aes(xend = xval.inc, yend = end.bin-20, size = n_inc/2),
  ...
  facet_wrap(~DIA_class)+scale_size(range = c(0, 2))+scale_x_discrete(labels=c("2" = "No Change", "1" = "Increasing",
...
ncell.change.1990.2000 <- fia.surveys.wide %>% group_by(dens.bins.1990, DIA_class) %>% dplyr::summarise(n_inc = sum(pct_inc_1990_2000 > 5, na.rm = TRUE),
...
ncell.change.1990.2000 <- merge(ncell.change.1990.2000, bins.df)
...
# get number of cells changing between 1980 to 2000:
ncell.change.1980.2000 <- fia.surveys.wide %>% group_by(dens.bins.1980, DIA_class) %>% dplyr::summarise(n_inc = sum(pct_inc_1980_2000 > 5, na.rm = TRUE),
...
ncell.change.1980.2000 <- merge(ncell.change.1980.2000, bins.df)
...
ncell.pct.change.1980.2000.plot <- ggplot(ncell.pct.change.1980.2000, aes(xval.inc, start.bin))+geom_segment(aes(xend = xval.inc, yend = end.bin-20, size = pct_inc/2),
                                                                                                             arrow = arrow(length = unit(0.1,"cm")), color = "#2166ac")+
  geom_point(data = ncell.pct.change.1980.2000, aes(xval.nochange, start.bin+20, size = pct_nochange), color = "#636363")+
  geom_segment(aes(x = xval.dec, y = end.bin-20, xend = xval.dec, yend = start.bin, size = pct_dec), arrow = arrow(length = unit(0.1,"cm")), color = "#b2182b")+
  scale_size(range = c(0, 2))+facet_wrap(~DIA_class)+scale_x_discrete(labels=c("2" = "No Change", "1" = "Increasing",
...
# P-PET Many arrows
ncell.change.ppet <- fia.full.surveys.clim.wide  %>% group_by(dens.bins.1980, ppet_bins, DIA_class) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                                              n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                              n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))
ncell.change <- fia.full.surveys.clim.wide %>% group_by(dens.bins.1980, DIA_class) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                             n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                             n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))
ncell.change <- merge(ncell.change, bins.df)
...
ordered.cuts <- data.frame(ppet_bins10 = unique(cut(dens.msk1980.2000.10[order(dens.msk1980.2000.10$GS_ppet_mod),]$GS_ppet_mod, breaks=seq(-170, 205, by = 50))),
                           mids = seq(-70, 180, by = 50))

dens.msk1980.2000.10 <- merge(dens.msk1980.2000.10, ordered.cuts, by = "ppet_bins10")

ncell.change.ppet <- dens.msk1980.2000.10 %>% group_by(dens.bins.1980, ppet_bins10, DIA_class, mids) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5,  na.rm = TRUE),
                                                                                                               n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                               n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))
ncell.change.ppet <- merge(ncell.change.ppet, ncell.change[, c("dens.bins.1980", "start.bin", "end.bin")], by = "dens.bins.1980")
...
ncell.pct.change.ppet$DIA_class <- factor(ncell.pct.change.ppet$DIA_class , levels = c("1-4 in", "4-8 in", ">8 in"))


# ideally we want to have it be the most common class, but this will do for now
pct.inc.ppet1980.2000 <- ggplot(na.omit(ncell.pct.change.ppet[ncell.pct.change.ppet$pct_inc >=50,]), aes(mids, start.bin))+geom_segment(aes(xend = mids, yend = end.bin-20),
                                                                                                                               arrow = arrow(length = unit(0.15,"cm")), color = "#2166ac")+
...
fia.full.surveys.clim.wide$FIAminus1980 <- fia.full.surveys.clim.wide$`2000s`-  fia.full.surveys.clim.wide$`1980s`
fia.full.surveys.clim.wide$DIA_class <- factor(fia.full.surveys.clim.wide$DIA_class, levels = c("1-4 in", "4-8 in", ">8 in"))
ncell.change.pc1 <- fia.full.surveys.clim.wide %>% group_by(dens.bins.1980, pc1_bins, DIA_class) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                                           n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                           n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))

ncell.change.pc1 <- merge(ncell.change.pc1, ncell.change[, c("dens.bins.1980", "DIA_class","start.bin", "end.bin")], by = "dens.bins.1980")
...
ncell.change.pc1 <- dens.pc1.msk.10 %>% group_by(dens.bins.1980, pc1_bins10,DIA_class,  mids) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                                        n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                        n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))

ncell.change.pc1 <- merge(ncell.change.pc1, ncell.change[, c("dens.bins.1980", "DIA_class","start.bin", "end.bin")], by = c("dens.bins.1980", "DIA_class"))
...
ncell.pct.change.pc1$DIA_class <- factor(ncell.pct.change.pc1$DIA_class , levels = c("1-4 in", "4-8 in", ">8 in"))
...
ncell.change.soil <- fia.full.surveys.clim.wide %>% group_by(dens.bins.1980,DIA_class, soil_bins) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                                             n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                             n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))

ncell.change.soil <- merge(ncell.change.soil, ncell.change[, c("dens.bins.1980","DIA_class", "start.bin", "end.bin")], by = c("dens.bins.1980", "DIA_class"))
...
ggplot(ncell.change.soil, aes(soil_bins, start.bin))+geom_segment(aes(xend = soil_bins, yend = end.bin-20, size = n_inc/2),
  ...
  geom_segment(aes( y = end.bin-20, xend = soil_bins, yend = start.bin, size = n_dec/2), arrow = arrow(length = unit(0.15,"cm")), color = "#b2182b")+facet_wrap(~DIA_class)
...
ncell.change.soil <- dens.soil.msk.10 %>% group_by(dens.bins.1980, DIA_class, soil_bins10, mids) %>% dplyr::summarise(n_inc = sum(FIAminus1980 > 5, na.rm = TRUE),
                                                                                                           n_dec = sum(FIAminus1980 < -5, na.rm = TRUE),
                                                                                                           n_nochange = sum(FIAminus1980 >= -5 & FIAminus1980 <= 5 , na.rm = TRUE))
...
ncell.pct.change.soil <- ncell.pct.change.soil %>% filter(!DIA_class %in% "NA")
ncell.pct.change.soil$DIA_class <- factor(ncell.pct.change.soil$DIA_class , levels = c("1-4 in", "4-8 in", ">8 in"))
# ideally we want to have it be the most common class, but this will do for now
pct.inc.soil.1980.2000 <- ggplot(na.omit(ncell.pct.change.soil[ncell.pct.change.soil$pct_inc >=50,]), aes(mids, start.bin))+geom_segment(aes(xend = mids, yend = end.bin-20),
                                                                                                                                arrow = arrow(length = unit(0.15,"cm")), color = "#2166ac")+
...
png(height = 15, width = 10, units = "in", res = 300, "outputs/paper_figs_unc/Change_trajectory_1980_2000s_arrows_across_envts_cleaner_by_diameter_classes.png")
...
plot_grid(pls.map.alt.color + theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA)) + annotate("text", x=-90000, y=1486000,label= "A", size = 3), 
          ...
          pls.clust + theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA)) + annotate("text", x=-90000, y=1486000,label= "B", size = 3),
          fia.clust + theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA)) + annotate("text", x=-90000, y=1486000,label= "E", size = 3), 
          clust.hist.full.no.aspect + xlab("Tree Density (stems/ha)")+ ylab("# of grid cells")+ theme(plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 10), axis.title =  element_text(size = 10))+ annotate("text", x=600, y=50,label= "C", size = 3),
          #hist.inset+ theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 5), axis.title =  element_text(size = 5)) + annotate("text", x=600, y=20,label= "F", size = 3), 
...
plot_grid(pls.map.alt.color + theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA)) + annotate("text", x=-90000, y=1486000,label= "A", size = 3), 
          ...
          clust.hist.full.both.no.aspect + xlab("Tree Density (stems/ha)")+ ylab("# of grid cells")+ theme(plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 10), axis.title =  element_text(size = 10))+ annotate("text", x=600, y=100,label= "C", size = 3),
          #hist.inset+ theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 5), axis.title =  element_text(size = 5)) + annotate("text", x=600, y=20,label= "F", size = 3), 
...
plot_grid(pls.map.alt.color.msk + theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA)) + annotate("text", x=-90000, y=1486000,label= "A", size = 3), 
          ...
          clust.hist.full.both.no.aspect.msk + xlab("Tree Density (stems/ha)")+ ylab("# of grid cells")+ theme(plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 10), axis.title =  element_text(size = 10))+ annotate("text", x=600, y=100,label= "C", size = 3),
          #hist.inset+ theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 5), axis.title =  element_text(size = 5)) + annotate("text", x=600, y=20,label= "F", size = 3), 
          
          clust.hist.fia.full.both.no.aspect.msk+xlab("Tree Density (stems/ha)")+ylab("# of grid cells") + theme(plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), plot.background=element_rect(fill=NA, colour=NA), axis.text = element_text(size = 10), axis.title =  element_text(size = 10),  axis.ticks.y =element_blank() ) + annotate("text", x=600, y=200,label= "F", size = 3), 
          ncol = 2, align = "h", axis="tb", scale = 1 ) 
dev.off()
...
# get data frame w/ 1980s, 1990s, and modern survey estimates:
modern.fia <- dens.clust.omit[,c("x", "y", "cell", "FIAdensity")]
modern.fia$INVYRcd <- "2000s"
...
pc.pls.mix$mode <- ifelse(pc.pls.mix$mode %in% "Savanna", "Low Tree Density", "High Tree Density")
...
mid.summary.pc1.quants <- pc.pls.mix  %>% group_by(mode, pc1_bins, mids) %>% dplyr::summarise(mean = mean(mean_dens),
                                                                                              ci.low = quantile(mean_dens,0.025),
                                                                                              ci.high = quantile(mean_dens, 0.975),
                                                                                              ci.90 = quantile(mean_dens,0.9),
                                                                                              ci.10 = quantile(mean_dens, 0.1),
...
merged.pc1$bimodal <- ifelse(merged.pc1$low_Forest > merged.pc1$high_Savanna & merged.pc1$`Low Tree Density` +  merged.pc1$`High Tree Density` > 50,"bimodal", "NS")
...
hysteresis.pc1.pls.quants <- ggplot(data = data.frame(mid.summary.pc1.quants), aes(mids, ci.50, color = mode))+geom_line()+geom_ribbon(data = mid.summary.pc1.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  ...
  ylab("Mean Tree Density (stems/ha)")+xlab("Principle Component 1")+theme(panel.grid.major = element_blank())
...
hysteresis.pc1.pls.smooth.95ci <- ggplot(data = data.frame(mid.summary.pc1.quants), aes(mids, ci.50, color = mode))+stat_smooth(se =FALSE)+geom_ribbon(data = mid.summary.pc1.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+geom_smooth(data = mid.summary.lowprob[mid.summary.lowprob$`prob >= 0.49 &  prob <= 0.51` %in% T,], aes(mids, mean), color = "black", linetype = "dashed",se = FALSE)+
  ylab("Mean Tree Density (stems/ha)")+xlab("Principle Component 1")+theme(panel.grid.major = element_blank())
...
smoothingSpline.Savanna.ci.low = smooth.spline(mid.summary.pc1[mid.summary.pc1$mode %in% "Savanna", ]$mids, mid.summary.pc1[mid.summary.pc1$mode %in% "Savanna", ]$ci.low, spar=.75)
smoothingSpline.Savanna.ci.high = smooth.spline(mid.summary.pc1[mid.summary.pc1$mode %in% "Savanna", ]$mids, mid.summary.pc1[mid.summary.pc1$mode %in% "Savanna", ]$ci.high, spar=.75)
...
pls.kde.plot.pc1.gg.lines <- as.ggplot(~plot(fhat, display="filled.contour2", cont=c(1,5,10,15,25,30,50,60,75,85,95), xlab = "PC1", ylab = "Tree density", ylim = c(-40,550), cex.axis = 0.7 ) + points(merged.pc1[merged.pc1$bimodal %in% "bimodal",]$mids , merged.pc1[merged.pc1$bimodal %in% "bimodal",]$y, col = "darkblue", pch = 15, cex = 1)+
                                         lines(smoothingSpline.Savanna, lwd = 2, col = "brown")+  lines(smoothingSpline.Forest, lwd = 2, col = "forestgreen") +
                                         text(-5, 500, "A"))
...
ppet.pls.mix$mode <- ifelse(ppet.pls.mix$mode %in% "Savanna", "Low Tree Density" ,"High Tree Density")
...
mid.summary.ppet.quants.pls <- mid.summary.ppet.quants
...
hysteresis.ppet.pls.quants <- ggplot(data = data.frame(mid.summary.ppet), aes(mids_ppet, mean, color = mode))+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.ppet, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  ...
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season P-PET")+theme(panel.grid.major = element_blank())




hysteresis.ppet.pls.quants <- ggplot(data = data.frame(mid.summary.ppet.quants), aes(mids_ppet, ci.50, color = mode))+geom_line()+geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.10, ymax = ci.90, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.20, ymax = ci.80, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.30, ymax = ci.70, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.40, ymax = ci.60, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
...
hysteresis.ppet.pls.smooths <- ggplot(data = data.frame(mid.summary.ppet.quants), aes(mids_ppet, ci.50, color = mode))+stat_smooth(se =FALSE)+geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.10, ymax = ci.90, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.20, ymax = ci.80, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.30, ymax = ci.70, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.40, ymax = ci.60, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.ppet.pls.smooth.95ci <- ggplot(data = data.frame(mid.summary.ppet.quants), aes(mids_ppet, ci.50, color = mode))+stat_smooth(se =FALSE)+geom_ribbon(data = mid.summary.ppet.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season P-PET")+theme(panel.grid.major = element_blank())
...
merged.ppet$bimodal <- ifelse(merged.ppet$low_Forest > merged.ppet$high_Savanna & merged.ppet$`Low Tree Density` +  merged.ppet$`High Tree Density` > 50,"bimodal", "NS")
...
soil.pls.mix$ mode <- ifelse(soil.pls.mix$mode %in% "Savanna", "Low Tree Density", "High Tree Density")
mid.summary.soil <- soil.pls.mix %>% group_by(mode, mean_GS_soil_bins, mids) %>% dplyr::summarise(mean = median(mean_dens),
                                                                                                  meadian = median(mean_dens),
                                                                                                  ci.low = quantile(mean_dens,0.025),
                                                                                                  ci.high = quantile(mean_dens, 0.975), 
                                                                                                  ncell = length(mean_dens) )
...
mid.summary.soil.quants.pls <- mid.summary.soil.quants
...
hysteresis.soil.pls.quants <- ggplot(data = data.frame(mid.summary.soil.quants), aes(mids, ci.50, color = mode))+geom_line()+geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.10, ymax = ci.90, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.soil.pls.smooths <- ggplot(data = data.frame(mid.summary.soil.quants), aes(mids, ci.50, color = mode))+stat_smooth(se =FALSE)+geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.10, ymax = ci.90, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.20, ymax = ci.80, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.30, ymax = ci.70, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.40, ymax = ci.60, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.soil.pls.smooth.95ci <- ggplot(data = data.frame(mid.summary.soil.quants), aes(mids, ci.50, color = mode))+stat_smooth(se =FALSE)+geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season Soil Moisture")+theme(panel.grid.major = element_blank())
...
merged.soil$bimodal <- ifelse(merged.soil$low_Forest > merged.soil$high_Savanna & merged.soil$`Low Tree Density` + merged.soil$`High Tree Density` > 50,"bimodal", "NS")
...
pc1.fia.mix$mode <- ifelse(pc1.fia.mix$mode %in% "Savanna","Low Tree Density", "High Tree Density" )
...
mid.summary.pc1.quants.one <- pc1.fia.mix  %>% group_by( pc1_bins_fia, mids) %>% dplyr::summarise(mean = mean(mean_dens_fia),
                                                                                                  ci.low = quantile(mean_dens_fia,0.025),
                                                                                                  ci.high = quantile(mean_dens_fia, 0.975),
                                                                                                  ci.90 = quantile(mean_dens_fia,0.9),
                                                                                                  ci.10 = quantile(mean_dens_fia, 0.1),
                                                                                                  ...
                                                                                                  ci.50 = quantile(mean_dens_fia, 0.5),
                                                                                                  ncell = length(mean_dens_fia))
...
hysteresis.pc1.fia.quants <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Principle Componenet 1")+theme(panel.grid.major = element_blank())

hysteresis.pc1.fia.quants.dashed <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_line(data = mid.summary.pc1.quants.pls, aes(mids, ci.50, color = mode),  linetype = "dashed")+scale_color_manual(values = c("#636363", "#636363"))+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Principle Componenet 1")+theme(panel.grid.major = element_blank(), legend.position = "none")


hysteresis.pc1.fia.smooths <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.pc1.fia.smooth.95ci <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50))+stat_smooth(se =FALSE, color = "#005a32")+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Principle Componenet 1")+theme(panel.grid.major = element_blank())
...
low_ci <- mid.summary.pc1 %>%dplyr::select(mode, mids, ci.low) %>% spread(key = mode, value = ci.low, drop = TRUE)
high_ci <- mid.summary.pc1 %>%dplyr::select(mode, mids,ci.high) %>% spread(key = mode, value = ci.high, drop = TRUE)
colnames(low_ci)[3] <- c("low_Forest")
colnames(high_ci)[3] <- c("high_Forest")
...
merged.fia.pc1$bimodal <- ifelse("Low Tree Density" %in% colnames(merged.fia.pc1),"check", "One mode")
...
fia.kde.plot.pc1.gg <- as.ggplot(~plot(fhat, display="filled.contour2", cont=c(1,5,10,15,25,30,50,60,75,85,95), ylab = " ",xlab = "PC1",  ylim = c(-40,550),  yaxt="n", cex.axis=0.7))+ text(-5.5,500, "E")+  xlab("P-PET")
...
ppet.fia.mix$mode <- ifelse(ppet.fia.mix$mode %in% "Savanna", "Low Tree Density", "High Tree Density")
mid.summary.ppet <- ppet.fia.mix %>% group_by(mode, GS_ppet_mod_bins, mids) %>% dplyr::summarise(mean = mean(mean_dens_fia),
                                                                                                 ci.low = quantile(mean_dens_fia,0.025),
                                                                                                 ci.high = quantile(mean_dens_fia, 0.975), 
                                                                                                 ncell = length(mean_dens_fia))

mid.summary.ppet.quants <- ppet.fia.mix  %>% group_by(mode,  GS_ppet_mod_bins, mids) %>% summarise(mean = mean(mean_dens_fia),
                                                                                                   ci.low = quantile(mean_dens_fia,0.025),
                                                                                                   ci.high = quantile(mean_dens_fia, 0.975),
                                                                                                   ci.90 = quantile(mean_dens_fia,0.9),
                                                                                                   ci.10 = quantile(mean_dens_fia, 0.1),
...
mid.summary.ppet.quants.one <- ppet.fia.mix  %>% group_by(GS_ppet_mod_bins, mids) %>% dplyr::summarise(mean = mean(mean_dens_fia),
                                                                                                       ci.low = quantile(mean_dens_fia,0.025),
                                                                                                       ci.high = quantile(mean_dens_fia, 0.975),
                                                                                                       ci.90 = quantile(mean_dens_fia,0.9),
                                                                                                       ci.10 = quantile(mean_dens_fia, 0.1),
...
hysteresis.ppet.fia.quants <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season P-PET")+theme(panel.grid.major = element_blank())

hysteresis.ppet.fia.quants.dashed <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_line(data = mid.summary.ppet.quants.pls, aes(mids_ppet, ci.50, color = mode),  linetype = "dashed")+scale_color_manual(values = c("#636363", "#636363"))+
  theme_bw()+#scale_color_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season P-PET")+theme(panel.grid.major = element_blank(), legend.position = "none")


hysteresis.ppet.fia.smooths <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids, ci.50), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.ppet.fia.smooth.95ci <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids, ci.50))+stat_smooth(se =FALSE, color = "#005a32")+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season P-PET")+theme(panel.grid.major = element_blank())
...
merged.fia.ppet$bimodal <- ifelse("Low Tree Density" %in% colnames(merged.fia.ppet),"recheck", "NS")
...
fia.kde.plot.ppet.gg <- as.ggplot(~plot(fhat, display="filled.contour2", cont=c(1,5,10,15,25,30,50,60,75,85,95), xlab="P-PET",ylab=NA,  ylim = c(-40,550), xlim = c(-200, 300),  yaxt="n" , cex.axis=0.7) +  text(-170,500, "F"))+xlab("P-PET")
...
soil.fia.mix$mode <- ifelse(soil.fia.mix$mode %in% "Savanna", "Low Tree Density", "High Tree Density")
...
mid.summary.soil.quants.one <- soil.fia.mix  %>% group_by(mean_GS_soil_m_bins, mids) %>% dplyr::summarise(mean = mean(mean_dens_fia),
                                                                                                          ci.low = quantile(mean_dens_fia,0.025),
                                                                                                          ci.high = quantile(mean_dens_fia, 0.975),
                                                                                                          ci.90 = quantile(mean_dens_fia,0.9),
                                                                                                          ci.10 = quantile(mean_dens_fia, 0.1),
...
hysteresis.soil.fia.quants <- ggplot(data = data.frame(mid.summary.soil.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season Soil Moisture")+theme(panel.grid.major = element_blank())

hysteresis.soil.fia.quants.dashed <- ggplot(data = data.frame(mid.summary.soil.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  geom_line(data = mid.summary.soil.quants.pls, aes(mids, ci.50, color = mode),  linetype = "dashed")+scale_color_manual(values = c("#636363", "#636363"))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season Soil Moisture")+theme(panel.grid.major = element_blank(), legend.position = "none")


hysteresis.soil.fia.smooths <- ggplot(data = data.frame(mid.summary.soil.quants.one), aes(mids, ci.50), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
...
hysteresis.soil.fia.smooth.95ci <- ggplot(data = data.frame(mid.summary.soil.quants.one), aes(mids, ci.50))+stat_smooth(se =FALSE, color = "#005a32")+geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("Growing Season Soil Moisture")+theme(panel.grid.major = element_blank())



hysteresis.soil.fia.quants.two <- ggplot(data = data.frame(mid.summary.soil), aes(mids, mean, color = mode))+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.soil, aes(ymin = ci.low, ymax = ci.high, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.20, ymax = ci.80, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.30, ymax = ci.70, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants, aes(ymin = ci.40, ymax = ci.60, fill = mode), alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+#geom_smooth(data = mid.summary.lowprob[mid.summary.lowprob$`prob >= 0.49 &  prob <= 0.51` %in% T,], aes(mids, mean), color = "black", linetype = "dashed",se = FALSE)+
...
merged.fia.soil$bimodal <- ifelse("Low Tree Density" %in% colnames(merged.fia.soil),"recheck", "One mode")
...
fia.kde.plot.sm.gg <- as.ggplot(~plot(fhat, display="filled.contour2", cont=c(1,5,10,15,25,30,50,60,75,85,95), xlab = "Soil Moisture", ylab = NA, ylim = c(-40,550), yaxt="n",  cex.axis=0.9) + text(0.1,500, "G"))
fia.kde.plot.sm.gg 

fia.kde.plot.sm.gg.lines <- as.ggplot(~plot(fhat, display="filled.contour2", cont=c(1,5,10,15,25,30,50,60,75,85,95), ylab = " ",xlab = "PC1",  ylim = c(-40,550),  yaxt="n", cex.axis=0.7) +
...
# plot out and save the hysteresis figures:
legend <- get_legend(hysteresis.pc1.pls.quants)

png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_quants.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.quants + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.pc1.fia.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.pls.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.fia.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.pls.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.fia.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500), ncol = 2, align = "hv", labels = c("A", "D", "B", "E", "C", "F"), label_x = 0.19, label_y = 0.98),
  legend, rel_widths = c(1, 0.25))
dev.off()


png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_quants_dashed.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.quants + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.pc1.fia.quants.dashed+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.pls.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.fia.quants.dashed+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.pls.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.fia.quants.dashed+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500), ncol = 2, align = "hv", labels = c("A", "D", "B", "E", "C", "F"), label_x = 0.19, label_y = 0.98),
  legend, rel_widths = c(1, 0.25))
dev.off()

png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_smooths.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.smooths + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.pc1.fia.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.pls.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.fia.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.pls.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.soil.fia.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500), ncol = 2, align = "hv", labels = c("A", "D", "B", "E", "C", "F"), label_x = 0.19, label_y = 0.98),
  legend, rel_widths = c(1, 0.25))
dev.off()

png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_smooth_95ci.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.smooth.95ci + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800),
            hysteresis.pc1.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800),
            hysteresis.ppet.pls.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800),
            hysteresis.ppet.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800),
            hysteresis.soil.pls.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800),
            hysteresis.soil.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,800), ncol = 2, align = "hv", labels = c("A", "D", "B", "E", "C", "F"), label_x = 0.19, label_y = 0.98),
  legend, rel_widths = c(1, 0.25))
dev.off()
...
bim.class.m.f <- merge(bim.class.m.f, kde.surf.ppet.fia.df[,c("x", "y", "bimodal")], all.x = TRUE)
...
plot_grid(legends,
          plot_grid(hysteresis.pc1.pls.quants.bimodal + ylim(-27, 600)+theme(panel.grid = element_blank(), legend.position = "none", plot.margin=unit(c(1,3,1,1), "mm")), hysteresis.pc1.fia.quants.dashed+ ylim(-27, 600)+theme(panel.grid = element_blank(),legend.position = "none", plot.margin=unit(c(1,1,1,3), "mm")), #flipped.pc1.hist.full+ xlim(-27, 600)+theme(panel.grid = element_blank(), axis.ticks= element_blank(), axis.title = element_blank(), axis.text = element_blank(), plot.margin=unit(c(0,1,0,-2), "mm"), panel.background=element_rect(fill = "transparent",colour = NA)),
                    ...
                    labels = c("A", "E", #"I", 
                               ...
                               "C", "G", #"K", 
                               "D", "H"), 
                    label_x = c(0.18, 0.22, 0.18, 0.22, 0.18, 0.22,  0.18, 0.22), label_y = 0.98)
          ,nrow = 2, rel_heights = c(0.05, 1))
...
png(height = 10, width = 7.2, units = "in", res = 500, "outputs/paper_figs_unc/figure2_hystereseis_plot_median_dashed_nohist_reorder_arrows.png")
...
plot_grid(legends,
          plot_grid( hysteresis.ppet.pls.quants.bimodal+xlim(-150, 220) + ylim(-27, 600)+theme(panel.grid = element_blank(),legend.position = "none", plot.margin=unit(c(1,3,1,1), "mm")), hysteresis.ppet.fia.quants.dashed + ylim(-27, 600)+xlim(-150, 220)+theme(panel.grid = element_blank(),legend.position = "none",plot.margin=unit(c(1,3,1,1), "mm")), pct.inc.ppet.10+ ylim(-27, 600)+xlim(-150, 220) +theme(panel.grid = element_blank(),axis.text.x = element_text(angle = 0), panel.background=element_rect(fill = "transparent",colour = NA)),
                     ...
                     label_x = c(0.22, 0.22, 0.22, 
                                 0.22, 0.22, 0.22, 
                                 0.22, 0.22, 0.22,
                                 0.18,0.18), label_y = 0.98), nrow = 2, rel_heights = c(0.05, 1))
...
pls.dens.omit <- pls.df[!is.na(pls.df$FIAdensity), ]

#pls.dens.omit <- pls.dens.omit[!is.na(pls.dens.omit$FIAdensity),]
pls.dens.omit$pls <- pls.dens.omit$mean_dens
...
hysteresis.pc1.fia.quants <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, mean), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.30, ymax = ci.70), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+#geom_smooth(data = mid.summary.lowprob[mid.summary.lowprob$`prob >= 0.49 &  prob <= 0.51` %in% T,], aes(mids, mean), color = "black", linetype = "dashed",se = FALSE)+
...
hysteresis.pc1.fia.quants.dashed <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  ...
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  geom_line(data = mid.summary.pc1.quants.pls, aes(mids, ci.50, color = mode),  linetype = "dashed")+scale_color_manual(values = c("#636363", "#636363"))+
  ylab("Mean Tree Density (stems/ha)")+xlab("growing season pc1 moisture")+theme(panel.grid.major = element_blank(), legend.position = "none")
...
hysteresis.pc1.fia.smooth.95ci <- ggplot(data = data.frame(mid.summary.pc1.quants.one), aes(mids, ci.50))+stat_smooth(se =FALSE, color = "#005a32")+geom_ribbon(data = mid.summary.pc1.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+scale_fill_manual(values = c('#005a32', '#8c510a'))+
  ylab("Mean Tree Density (stems/ha)")+xlab("growing season pc1 moisture")+theme(panel.grid.major = element_blank())
...
hysteresis.ppet.fia.quants <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids, mean), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.30, ymax = ci.70), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+#geom_smooth(data = mid.summary.lowprob[mid.summary.lowprob$`prob >= 0.49 &  prob <= 0.51` %in% T,], aes(mids, mean), color = "black", linetype = "dashed",se = FALSE)+
...
hysteresis.ppet.fia.quants.dashed <- ggplot(data = data.frame(mid.summary.ppet.quants.one), aes(mids_ppet, ci.50), color = "#005a32")+geom_line()+geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.low, ymax = ci.high), fill =  "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.10, ymax = ci.90), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.30, ymax = ci.70),fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.ppet.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32",alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+
  geom_line(data = mid.summary.ppet.quants.pls, aes(mids_ppet, ci.50, color = mode),  linetype = "dashed")+scale_color_manual(values = c("#636363", "#636363"))+
  ylab("Mean Tree Density (stems/ha)")+xlab("growing season ppet moisture")+theme(panel.grid.major = element_blank(), legend.position = "none")
...
hysteresis.soil.fia.quants <- ggplot(data = data.frame(mid.summary.soil.quants.one), aes(mids, mean), color = "#005a32")+stat_smooth(se = FALSE)+geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.low, ymax = ci.high), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.20, ymax = ci.80), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.30, ymax = ci.70), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  geom_ribbon(data = mid.summary.soil.quants.one, aes(ymin = ci.40, ymax = ci.60), fill = "#005a32", alpha = 0.25, linetype = "dashed", colour = NA)+
  theme_bw()+#+scale_fill_manual(values = c('#005a32', '#8c510a'))+scale_color_manual(values = c('#005a32', '#8c510a'))+#geom_smooth(data = mid.summary.lowprob[mid.summary.lowprob$`prob >= 0.49 &  prob <= 0.51` %in% T,], aes(mids, mean), color = "black", linetype = "dashed",se = FALSE)+
...
png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_quants_msk.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.quants + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.pc1.fia.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.pls.quants+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
...
png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_smooths_msk.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.smooths + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.pc1.fia.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
            hysteresis.ppet.pls.smooths+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,500),
...
png(height = 8, width = 7, units = "in", res = 300, "outputs/paper_figs_unc/hysteresis_fia_pls_smooth_95ci_msk.png")
plot_grid(
  plot_grid(hysteresis.pc1.pls.smooth.95ci + theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600),
            hysteresis.pc1.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600),
            hysteresis.ppet.pls.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600),
            hysteresis.ppet.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600),
            hysteresis.soil.pls.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600),
            hysteresis.soil.fia.smooth.95ci+ theme(legend.position = "none", panel.grid = element_blank())+ylim(0,600), ncol = 2, align = "hv", labels = c("A", "D", "B", "E", "C", "F"), label_x = 0.19, label_y = 0.98),
  legend, rel_widths = c(1, 0.25))
dev.off()
