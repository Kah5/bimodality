...
# get monthly values for soil moisture model:
...
setwd(paste0(workingdir,'/PRISM_ppt_stable_4kmM3_198101_201709_bil/'))
...
write.csv(full, paste0(workingdir,"outputs/temporary_melted_1981_2015.csv"))
...
test <- melt.temp[melt.temp$year %in% 1999:2015,] # only take 1999 - 2015 to cut down on years
melt.temp.byxy <- dcast(test, x + y ~  year + mos, mean, value.var = 'value', na.rm = TRUE)
...
saveRDS(avgs.df, paste0("/Users/kah/Documents/bimodality/outputs/PR_pls_extracted", "1999-2015",".RDS"))
