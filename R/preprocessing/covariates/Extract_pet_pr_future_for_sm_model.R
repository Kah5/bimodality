...
# --------------------------get lower rcp emission scenarios for 2028-2058------------------------
ccesm.pr <- stack("data/ccesm_2028_2058_rcp2.6_4_6/Extraction_pr.nc")
climate_output <- nc_open("data/ccesm_2028_2058_rcp2.6_4_6/Extraction_petnatveg.nc")
...
write.csv(pet.long, "outputs/cmip5_all_rcp_pet_long_2028_2058.csv", row.names = FALSE)
nc_close("data/ccesm_2028_2058_rcp2.6_4_6/Extraction_petnatveg.nc")

#pet.long <- read.csv("outputs/cmip5_rcp8.5_pet_long.csv")

# get the precipitation data from nc files:
climate_output <- nc_open("data/ccesm_2028_2058_rcp2.6_4_6/Extraction_pr.nc")
...
write.csv(pr.long, "outputs/cmip5_all_rcp_pr_long_2028_2058.csv", row.names = FALSE)
nc_close("data/ccesm_2028_2058_rcp2.6_4_6/Extraction_pr.nc")
...
#ppet.long <- dcast(pr, lon + lat ~ year_mo, fun.aggregate = mean, value.var='PPET', na.rm = TRUE)
write.csv(ppet.long, "outputs/cmip5_all_rcp_ppet_long_2028_2058.csv", row.names = FALSE)


ppet.long <- read.csv("outputs/cmip5_all_rcp_ppet_long_2028_2058.csv")
ppet.long$lon <- as.numeric(as.character(ppet.long$lon))
ppet.long$lat <- as.numeric(as.character(ppet.long$lat))
...
ppet.rast.alb.df$mean_ppet_GS <- rowMeans(ppet.rast.alb.df[,GS_index], na.rm=TRUE)
write.csv(ppet.rast.alb.df, "outputs/cmip5_rcp2.6_ppet_long_2028_2058.csv", row.names = FALSE)
...
write.csv(ppet.rast.alb.df, "outputs/cmip5_rcp4.5_ppet_long_2028_2058.csv", row.names = FALSE)
...
write.csv(ppet.rast.alb.df, "outputs/cmip5_rcp6.0_ppet_long_2028_2058.csv", row.names = FALSE)
...
ppet.rast.alb.df$x <- dens.pr$x
ppet.rast.alb.df$y <- dens.pr$y
ggplot(ppet.rast.alb.df, aes(x,y, fill = X2029_6))+geom_raster()


write.csv(ppet.rast.alb.df, "outputs/cmip5_rcp8.5_ppet_long_2028_2058.csv", row.names = FALSE)
